...
public class Door : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        winText.text = "";
        countText.text = "SHURIKENS: 0/5";
        collectablesCount = collectablesCount - 5;
